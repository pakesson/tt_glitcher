...
async def test_glitch_control_full_glitch_sequence(dut):
    ...
    await uart_source.write(b'\x00\x00\x12') # Set delay (Not implemented yet)
    ...
    # Delay is not implemented yet, so just wait for the actual rising edge of the pulse here
    await RisingEdge(dut.pulse_out)
